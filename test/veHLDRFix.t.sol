...
contract veHLDRFixTest is Test {
    ...
    address admin = 0x432Eb1f2730662AD1A9791Ed34CB2DBDf7001555;
    ...
    function testKillGauge() public {
        IAuthorizerAdaptor adaptor = IAuthorizerAdaptor(authorizerAdaptor);
        vm.prank(admin);
        adaptor.performAction(0xbC4B15225b06429ADCC990788b01C17aDbb1b315, hex"ab8f0945");
        // Test kill gauge
